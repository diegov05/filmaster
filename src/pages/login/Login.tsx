                ...
                <div className='flex flex-col justify-start items-start mt-8 gap-4'>
                    <form action="" className='flex flex-col justify-start items-start mt-8 gap-4'>
                        ...
                        <div className='w-full flex flex-row justify-between gap-2'>
                            ...
                            <button onClick={() => { }} disabled={authing} className='w-full rounded-none bg-zinc-900 outline-none border-none py-2 px-4 uppercase text-xs text-zinc-500 custom__button hover:opacity-90'>Guest Login</button>
                        </div>
